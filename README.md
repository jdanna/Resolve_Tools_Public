...
#### `RL_XML_NOTCH.py`
Notches a **baked (flattened) render of a Premiere Pro timeline**. Select the baked clip in the media pool, run the script, and point it at the FCP7 XML export of the Premiere sequence. Creates a new timeline containing the baked clip:
