...
win = dispatcher.AddWindow(
    {
        'ID': 'SetTCDialog',
        'WindowTitle': 'Batch Set Timecode',
        'Geometry': [700, 300, 320, 100],
    },
    ui.VGroup({'Spacing': 8}, [
        ui.HGroup({'Spacing': 6}, [
            ui.Label({'Text': 'New Timecode:', 'Weight': 0}),
            ui.SpinBox({'ID': 'HHInput', 'Minimum': 0, 'Maximum': 23, 'Value': 0, 'Weight': 1}),
            ui.SpinBox({'ID': 'MMInput', 'Minimum': 0, 'Maximum': 59, 'Value': 0, 'Weight': 1}),
            ui.SpinBox({'ID': 'SSInput', 'Minimum': 0, 'Maximum': 59, 'Value': 0, 'Weight': 1}),
            ui.SpinBox({'ID': 'FFInput', 'Minimum': 0, 'Maximum': 99, 'Value': 0, 'Weight': 1}),
        ]),
        ui.HGroup({'Spacing': 6}, [
            ui.HGap(),
...
def OnOK(ev):
    hh = itm['HHInput'].Value
    mm = itm['MMInput'].Value
    ss = itm['SSInput'].Value
    ff = itm['FFInput'].Value
    result['tc'] = "%02d:%02d:%02d:%02d" % (hh, mm, ss, ff)
...
win.On['SetTCDialog'].Close = OnClose
