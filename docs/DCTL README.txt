...
The EOTF fields correspond to the following Academy standard EOTF transforms:
    ...
    - 0: ST-2084 (PQ)
    - 1: BT.1886 with Gamma 2.4
    - 2: sRGB IEC 61966-2-1:1999 (mon_curve w/ presets)
    - 3: Gamma 2.6
    - 4: Display Linear (no EOTF)
    - 5: HLG
    - 6: Gamma 2.2
...
Note: - To invoke the parametric ACES Transform V2, we use the same functionalities as V1.
      ...
      - V2 parametric definition supports new EOTF option: Gamma 2.2.
