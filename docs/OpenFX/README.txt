...
In addition to supported architecture mentioned in https://openfx.readthedocs.io/en/main/Reference/ofxPackaging.html#installation-directory-hierarchy,
Resolve ARM64EC host on a Windows ARM64 platform will scan the architecture directories in this order: "Win-arm64x", "Win-arm64ec", "Win64".
